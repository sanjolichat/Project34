...
function setup() {
  ...
  playerBase = new PlayerBase(300, 550, 300, 150);
  player = new Player(285, playerBase.body.position.y - 153, 160, 250);
  ...
  board2 = new Board(width - 500, height - 300, 100, 300);
}
...
function keyPressed() {
  if (keyCode === 32) {
    if (numberOfArrows > 0) {
      ...
      var arrow = new PlayerArrow(posX, posY, 75, 75, angle);
